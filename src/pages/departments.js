...
function findDept(depts, deptId) {
  ...
  for (let i = 0; i < depts.length; i++) {
    ...
    const dept = findDept(depts[i].children, deptId)
    if (dept) {
      return dept
    }
  }
                  ...
                  <Space size="large">
                    <Tooltip title={t('newSubDept')}>
                      <Button
                        ...
                        icon={<PlusOutlined />}
                        onClick={() => {
                          const dept = newDept(t, selectedDeptId)
                    ...
                    <Tooltip title={t('move')}>
                      <Button
                        shape="circle"
                        icon={<DragOutlined style={{ cursor: 'move' }} />}
                      />
                    </Tooltip>
